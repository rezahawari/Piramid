                ...
                <div class="space-y-6 lg:col-span-5">
                    ...
                    >
                        ...
                        <div v-if="t.manual_transfer_proof_url" class="mt-4 space-y-3">
                            <div class="relative overflow-hidden rounded-xl border border-gray-200 bg-gray-50 flex items-center justify-center p-2 min-h-[160px]">
                                <a
                                    :href="t.manual_transfer_proof_url"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    title="Klik untuk membuka bukti ukuran penuh"
                            ...
                            <div class="flex items-center justify-between text-xs">
                                <span class="text-gray-500">Struk bukti pembayaran pembeli</span>
                                <a
                                    :href="t.manual_transfer_proof_url"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    class="font-bold text-brand-600 hover:text-brand-800 flex items-center gap-1"
                                >
                    ...
                    <div class="rounded-2xl border border-gray-100 bg-white p-6 shadow-sm">
                        ...
                        <!-- Rincian Nama Sohibul (Atas Nama Ibadah) -->
                        <div v-if="t.sohibul_names?.length" class="mt-4 rounded-xl border border-brand-200 bg-brand-50/40 p-3.5 text-xs">
                            <div class="flex items-center justify-between mb-1.5">
                                ...
                                <span class="rounded bg-brand-100 px-2 py-0.5 text-[10px] font-bold text-brand-800">
                                    {{ t.sohibul_names.length }} Nama
                                </span>
                            </div>
                            <ol class="list-decimal list-inside space-y-1 text-gray-800 font-semibold">
                                <li v-for="(name, idx) in t.sohibul_names" :key="idx" class="text-xs">
                                    {{ name }}
                                </li>
                            </ol>
                        </div>
