    ...
    <div class="fixed bottom-3 inset-x-0 z-50 flex justify-center px-4 pointer-events-none md:hidden">
        ...
        >
            ...
            >
                ...
                <span class="text-[9px] mt-0.5 tracking-tight">Layanan</span>
            </Link>
            ...
            >
                ...
                <span class="text-[9px] mt-0.5 tracking-tight">Transaksi</span>
            </Link>
            ...
            >
                ...
                <span class="text-[9px] mt-0.5 tracking-tight">Admin</span>
            </Link>
